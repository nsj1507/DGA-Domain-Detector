# DGA Domain Detector Design System design system
...
workspace package (`@workspace/dga-domain-detector-design-system`): other artifacts depend
...
- `docs/references/component-inventory.md` — extracted component and composition
  inventory from the DGA Domain Detector app.
- `docs/references/components/` — source notes for the analyst controls and
  readout patterns captured from the existing app.
...
`@workspace/dga-domain-detector-design-system/components/...`. Never use a `@/` alias inside
...
for `@workspace/dga-domain-detector-design-system` and renders mockups using this package's
theme and components.

## Consuming this package

Never copy token values, component source, hooks, or these docs into a consuming
artifact. Add `@workspace/dga-domain-detector-design-system` as a `workspace:*` dependency,
...
- Building or styling web UI: `artifacts/dga-domain-detector-design-system/docs/consuming-web.md`
- Building or styling Expo UI: `artifacts/dga-domain-detector-design-system/docs/consuming-expo.md`
- Building or styling a slide deck: `artifacts/dga-domain-detector-design-system/docs/consuming-slides.md`
- Replacing an existing or scaffolded web theme/component library:
  `artifacts/dga-domain-detector-design-system/docs/migrating-web.md`
- Replacing existing or scaffolded Expo theme/hooks/components:
  `artifacts/dga-domain-detector-design-system/docs/migrating-expo.md`
