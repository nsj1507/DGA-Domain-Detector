# Consuming DGA Domain Detector Design System in Expo apps

Read `artifacts/dga-domain-detector-design-system/docs/AGENTS.md` first. React Native does
...
`artifacts/dga-domain-detector-design-system/docs/migrating-expo.md` before writing UI.
...
```tsx
import { tokens } from "@workspace/dga-domain-detector-design-system/tokens";
...
```tsx
import { nativeTheme } from "@workspace/dga-domain-detector-design-system/lib/native-theme";
import { useColors } from "@workspace/dga-domain-detector-design-system/hooks/use-colors";
import { useDesignSystemFonts } from "@workspace/dga-domain-detector-design-system/hooks/use-fonts";
```
...
```tsx
import { Badge } from "@workspace/dga-domain-detector-design-system/components/native/badge";
import { Button } from "@workspace/dga-domain-detector-design-system/components/native/button";
import { Card } from "@workspace/dga-domain-detector-design-system/components/native/card";
```
...
Import and render
`@workspace/dga-domain-detector-design-system/components/native/button`, then run Expo
