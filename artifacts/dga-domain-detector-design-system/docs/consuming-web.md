# Consuming DGA Domain Detector Design System in web apps

Read `artifacts/dga-domain-detector-design-system/docs/AGENTS.md` first. This guide covers
...
`artifacts/dga-domain-detector-design-system/docs/migrating-web.md` before writing UI.
...
```css
@import "@workspace/dga-domain-detector-design-system/styles.css";
```
...
`node_modules/@workspace/dga-domain-detector-design-system/src/components` to `content`.
...
```tsx
import { Button } from "@workspace/dga-domain-detector-design-system/components/ui/button";
import { cn } from "@workspace/dga-domain-detector-design-system/lib/utils";
import {
  toast,
  useToast,
} from "@workspace/dga-domain-detector-design-system/hooks/use-toast";
```
...
`@workspace/dga-domain-detector-design-system/components/ui/button`. Run the app's typecheck
