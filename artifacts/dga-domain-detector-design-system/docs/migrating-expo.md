# Migrating Expo UI to DGA Domain Detector Design System

Read `artifacts/dga-domain-detector-design-system/docs/AGENTS.md` and
`artifacts/dga-domain-detector-design-system/docs/consuming-expo.md` first. Use this guide
...
- Rewrite color/theme imports to
  `@workspace/dga-domain-detector-design-system/lib/native-theme` and
  `@workspace/dga-domain-detector-design-system/hooks/use-colors`.
- Rewrite the root layout to use
  `@workspace/dga-domain-detector-design-system/hooks/use-fonts` while preserving its
  SplashScreen gating.
...
and hook directly from `@workspace/dga-domain-detector-design-system` and retains only
