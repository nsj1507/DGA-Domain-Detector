# Migrating web UI to DGA Domain Detector Design System

Read `artifacts/dga-domain-detector-design-system/docs/AGENTS.md` and
`artifacts/dga-domain-detector-design-system/docs/consuming-web.md` first. Use this guide
...
- `@/components/ui/<name>` →
  `@workspace/dga-domain-detector-design-system/components/ui/<name>`
- `@/lib/utils` (`cn`) → `@workspace/dga-domain-detector-design-system/lib/utils`
- `@/hooks/use-toast` → `@workspace/dga-domain-detector-design-system/hooks/use-toast`
