...
export const DESIGN_SYSTEM = {
  title: 'DGA Domain Detector Design System',
  description:
    'A calm analyst-workspace language for transparent domain intelligence readouts.',
} as const;
...
export const NAV_GROUPS: NavGroup[] = [
  ...
  {
    name: 'Analyst controls',
    entries: [
      {
        id: 'analyst-button',
        name: 'Actions',
        description: 'Compact, high-contrast actions for an analyst workflow.',
        Page: ButtonDemo,
      },
      {
        id: 'analyst-input',
        name: 'Domain input',
        description: 'Monospaced domain entry with focus and validation states.',
        Page: InputDemo,
      },
      {
        id: 'analyst-form',
        name: 'Input form',
        description: 'Single-channel form composition for starting an analysis.',
        Page: FormDemo,
      },
    ],
  },
    ...
    entries: [
      {
        id: 'readout-card',
        name: 'Readout cards',
        description: 'Layered surfaces for verdicts, model metadata, and history.',
        Page: CardDemo,
      },
      {
        id: 'readout-badge',
        name: 'Risk badges',
        description: 'Compact low-risk, high-risk, and system-state labels.',
        Page: BadgeDemo,
      },
      {
        id: 'readout-alert',
        name: 'System alerts',
        description: 'Quiet attention states for model availability and analysis errors.',
        Page: AlertDemo,
      },
      {
        id: 'readout-disclosure',
        name: 'Configuration disclosure',
        description: 'Progressive disclosure for model details and feature metadata.',
        Page: CollapsibleDemo,
      },
      {
        id: 'readout-loading',
        name: 'Loading states',
        description: 'Reserved loading shapes for model and result panels.',
        Page: SkeletonDemo,
      },
    ],
  },
    ...
    entries: [
      {
        ...
        description: 'Subtle reveal and scan-line cues used during analysis.',
        Page: SpinnerDemo,
      },
    ],
  },
